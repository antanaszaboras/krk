        ...
        <form>
          <div class="form-row">
            <div class="col-md-6 mb-2">
              ...
              <input type="text" class="form-control" id="validationServer01" placeholder="John" value="<?php echo $contacts_item['name']; ?>" required>
            </div>
            <div class="col-md-6 mb-2">
              <label for="validationServer02">Last name</label>
              <input type="text" class="form-control" id="validationServer02" placeholder="Doe" value="<?php echo $contacts_item['surname']; ?>">
            </div>
            <div class="col-md-6 mb-2">
              <label for="validationServer02">Phone</label>
              <input type="text" class="form-control" id="validationServer02" placeholder="+37012312345" value="<?php echo $contacts_item['phone']; ?>">
            </div>
            <div class="col-md-6 mb-2">
              ...
              <div class="input-group">
                ...
                <input type="email" class="form-control" id="validationServerEmail" placeholder="john.doe@contoso.com" aria-describedby="inputGroupPrepend3" value="<?php echo $contacts_item['email']; ?>"required>
              </div>
            </div>
          </div>
          <div class="form-row">
